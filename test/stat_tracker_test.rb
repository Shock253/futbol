...
class StatTrackerTest < Minitest::Test
  ...
  def setup
    ...
    @stat_tracker_full = StatTracker.from_csv(locations2)
  end
  ...
  #   assert_equal "FC Cincinnati", @stat_tracker_full.most_tackles("20132014")
  # end

  def test_it_can_calculate_most_accurate_team
    # refactor to not use the entire csv file
    assert_equal "Real Salt Lake", @stat_tracker_full.most_accurate_team("20132014")
  end

  def test_it_can_calculate_least_accurate_team
    # refactor to not use the entire csv file
    assert_equal "New York City FC", @stat_tracker_full.least_accurate_team("20132014")
  end

  def test_it_can_calculate_winningest_coach
    # refactor to not use the entire csv file
    assert_equal "Claude Julien", @stat_tracker_full.winningest_coach("20132014")
  end

  def test_it_can_calculate_worst_coach
    # refactor to not use the entire csv file
    assert_equal "Peter Laviolette", @stat_tracker_full.worst_coach("20132014")
  end
end
